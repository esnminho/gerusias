defmodule GerusiasWeb.BadgeControllerTest do
  ...
  describe "new badge" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.badge_path(conn, :new))
  ...
  describe "create badge" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == Routes.badge_path(conn, :show, id)
  ...
  describe "edit badge" do
    ...
    test "renders form for editing chosen badge", %{conn: conn, badge: badge} do
      conn = get(conn, Routes.badge_path(conn, :edit, badge))
  ...
  describe "update badge" do
    ...
    test "redirects when data is valid", %{conn: conn, badge: badge} do
      ...
      assert redirected_to(conn) == Routes.badge_path(conn, :show, badge)

      conn = get(conn, Routes.badge_path(conn, :show, badge))
  ...
  describe "delete badge" do
    ...
    test "deletes chosen badge", %{conn: conn, badge: badge} do
      ...
      assert redirected_to(conn) == Routes.badge_path(conn, :index)
