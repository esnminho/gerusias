defmodule GerusiasWeb.RedeemController do
  ...
  def index(conn, _params) do
    ...
    render(conn, "index.html", redeems: redeems)
  end
  ...
  def create(conn, %{"redeem" => redeem_params}) do
    case Contest.create_redeem(redeem_params) do
      {:ok, redeem} ->
        ...
        |> redirect(to: Routes.redeem_path(conn, :show, redeem))
  ...
  def delete(conn, %{"id" => id}) do
    ...
    |> redirect(to: Routes.redeem_path(conn, :index))
  end
end
